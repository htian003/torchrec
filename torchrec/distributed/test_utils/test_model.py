...
class ModelInput(Pipelineable):
    ...
    def to(
        ...
        if data_copy_stream is None:
            ...
            assert isinstance(self.idlist_features, KeyedJaggedTensor)
            idlist_features = KeyedJaggedTensor.empty_like(
            ...
            idscore_features = (
                ...
                if self.idscore_features is None
                    ...
                    # pyre-ignore[6]: Pyre doesn't narrow type through ternary
